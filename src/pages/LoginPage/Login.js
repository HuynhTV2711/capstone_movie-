          ...
          <div className='grid grid-cols-2'>
            ...
            <div className="col_right">
              <form className="max-w-sm mx-auto space-y-5" onSubmit={handleSubmit}>
                <h2 className='font-bold mb-5 text-3xl text-blue-400'>Đăng nhập movie</h2>
                <div className="mb-5">
                  <label htmlFor="taiKhoan" className="block mb-2 text-sm font-medium text-gray-900 text-blue-400">Tài khoản</label>
                  <input type="text" id="taiKhoan" name="taiKhoan" className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5" placeholder="Vui lòng nhập tài khoản..." onChange={handleChange} onBlur={handleBlur} value={values.taiKhoan} />
                  {errors.taiKhoan && touched.taiKhoan ? <p className='text-red-500 mt-1'>{errors.taiKhoan}</p> : ""}
                </div>
                <div className="mb-5">
                  <label htmlFor="matKhau" className="block mb-2 text-sm font-medium text-gray-900 text-blue-400">Mật khẩu</label>
                  <input type="password" id="matKhau" name="matKhau" className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5" placeholder='Vui lòng nhập mật khẩu...' onChange={handleChange} onBlur={handleBlur} value={values.matKhau} />
